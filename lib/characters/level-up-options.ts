...
export const SUBCLASS_OPTIONS: Record<string, SelectOption[]> = {
    Barbarian: [
        { value: "berserker", label: "Berserker", helper: "Primal Path" },
    ],
    Bard: [
        { value: "lore", label: "Lore", helper: "Bard College" },
    ],
    Cleric: [
        { value: "life", label: "Life", helper: "Divine Domain" },
    ],
    Druid: [
        { value: "land", label: "Land", helper: "Druid Circle" },
    ],
    Fighter: [
        { value: "champion", label: "Champion", helper: "Martial Archetype" },
    ],
    Monk: [
        { value: "open-hand", label: "Open Hand", helper: "Monastic Tradition" },
    ],
    Paladin: [
        { value: "devotion", label: "Devotion", helper: "Sacred Oath" },
    ],
    Ranger: [
        { value: "hunter", label: "Hunter", helper: "Ranger Archetype" },
    ],
    Rogue: [
        { value: "thief", label: "Thief", helper: "Roguish Archetype" },
    ],
    Sorcerer: [
        { value: "draconic", label: "Draconic", helper: "Sorcerous Origin" },
    ],
    Warlock: [
        { value: "fiend", label: "Fiend", helper: "Otherworldly Patron" },
    ],
    Wizard: [
        { value: "evocation", label: "Evocation", helper: "Arcane Tradition" },
    ],
};
...
export const SUBCLASS_DESCRIPTIONS: Record<string, SubclassInfo> = {
    berserker: {
        index: "berserker",
        name: "Berserker",
